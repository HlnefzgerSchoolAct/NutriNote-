...
│   ├── 🖼️ favicon.ico                  # Browser tab icon (16x16, 32x32)
│   ├── 🖼️ logo192.png                  # PWA icon for Android (192x192)
│   └── 🖼️ logo512.png                  # PWA icon for Android (512x512)
│
